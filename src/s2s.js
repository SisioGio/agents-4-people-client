...
class S2sChatBot extends React.Component {
    ...
    connectWebSocket() {
        ...
        if (this.socket === null || this.socket.readyState !== WebSocket.OPEN) {
            this.socket = new WebSocket(`wss://ag-digitalexpert.com/ws`);
            ...
            this.socket.onmessage = (message) => {
                ...
                console.log(`Reiceved msg from server: ${event}`)
        ...
        try {
            ...
            processor.onaudioprocess = async (e) => {
                if (this.state.sessionStarted) {
                    ...
                    console.log(`Sending input audio event`)
            ...
            this.mediaRecorder.ondataavailable = (event) => {
                console.log(`Pushing audio chunk ${event.data}`)
                this.state.audioChunks.push(event.data);
            };
            this.mediaRecorder.onstop = () => {
                console.log("Sending audioInput")
